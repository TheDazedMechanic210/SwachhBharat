...
function changePic() {
    ...
    if (yPos / window.innerHeight > 2) {
        document.getElementById("part2").src = "some2.jpg";
    }
    if (yPos / window.innerHeight > 1) {
        document.getElementById("part1").src = "some4.jpg";
    }
    if (yPos / window.innerHeight <= 1) {
        document.getElementById("part1").src = "some.jpg";
    }
    if (yPos / window.innerHeight <= 2) {
        document.getElementById("part2").src = "space.jpg";
    }

    if (yPos / window.innerHeight > 4) {
        document.getElementById("part2").src = "some6.jpg";
    }
}
